...
<table class="table table-sm table-hover">
    ...
    <tbody>
        ...
        foreach ($ListFasilitasKamar as $row) {
            ...
            $htmlData .= '<a href="/fasilitas-kamar/edit/' . $row['id_fasilitas_kamar'] . '" class="btn btn-info btn-sm mr-1">edit</a>';
            $htmlData .= '<a href="/fasilitas-kamar/hapus/' . $row['id_fasilitas_kamar'] . '" class="btn btn-danger btn-sm">hapus</a>';
            $htmlData .= '</td>';
            $htmlData .= '</tr>';
            echo $htmlData;
        }
